...
public class FraudOutboxService {
    ...
    public void enqueue(FraudDetectedEvent event) {
        ...
        FraudOutboxEvent outboxEvent = FraudOutboxEvent.pending(
        ...
        fraudOutboxRepository.save(outboxEvent);
    }
    ...
    private JsonNode serialize(FraudDetectedEvent event) {
